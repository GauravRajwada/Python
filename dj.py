...
def dijkstra(graph,start,goal):
    ...
    shortest_distance = {} #dict to record the cost to reach to node. We will constantly update this dictionary as we move along the graph.
    track_predecessor = {} #dicti to keep track of path that led to that node.
    unseenNodes = graph #to iterate through all nodes
    infinity = 99999 #infinity largest no
    track_path = [] #dict to record as we trace back our journey
